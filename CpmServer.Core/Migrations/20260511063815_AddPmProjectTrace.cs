        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PmProjectTrace_CrmCustomer_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "CrmCustomer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PmProjectTrace_CrmProduct_ProductId",
                        column: x => x.ProductId,
                        principalTable: "CrmProduct",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PmProjectTrace_QuoQuotation_QuotationId",
                        column: x => x.QuotationId,
                        principalTable: "QuoQuotation",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PmProjectTrace_ProductId",
                table: "PmProjectTrace",
                column: "ProductId");
